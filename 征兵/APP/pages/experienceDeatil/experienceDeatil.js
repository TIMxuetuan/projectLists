...
Page({
  ...
  getInfo(){
    ...
    util._get(config.service.getPersonalInfo, {}, (res) => {
      var str = res.data.mainExperience;
  ...
  buttonGo() {
    wx.navigateTo({
      url: '/pages/experience/experience?main=' + JSON.stringify(this.data.main)+'&index='+'',
    })
  },
  editorClick: function (e) {
    ...
    console.log(e)
    wx.navigateTo({
      url: '/pages/experience/experience?main=' + JSON.stringify(this.data.main) +'&index='+_index,
    })
  },
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          ...
          //获取要删除的id
          util._post(config.service.upload, { field: 'mainExperience', info: _main }, function (res) {
            if(res.Flag){
              wx.showToast({
                title: res.Content,
