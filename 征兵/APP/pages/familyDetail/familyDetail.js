...
Page({
  ...
  getInfo(){
    ...
    util._get(config.service.getPersonalInfo, {}, (res) => {
      var str = res.data.familyMembership;
  ...
  family() {
    wx.navigateTo({
      url: '/pages/family/family?main=' + JSON.stringify(this.data.main) + '&index=' + '',
    })
  },
  editorClick: function (e) {
    ...
    wx.navigateTo({
      url: '/pages/family/family?main=' + JSON.stringify(this.data.main) + '&index=' + _index,
    })
  },
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          ...
          //获取要删除的id
          util._post(config.service.upload, { field: 'familyMembership', info: _main }, function (res) {
            wx.showToast({
              title: '删除成功',
