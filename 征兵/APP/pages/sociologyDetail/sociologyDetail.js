...
Page({
  ...
  getInfo(){
    ...
    util._get(config.service.getPersonalInfo, {}, (res) => {
        var str = res.data.majorSocialRelationsMembership;
  ...
  goSociology() {
    wx.navigateTo({
      url: '/pages/sociology/sociology?main=' + JSON.stringify(this.data.main) + '&index=' + '',
    })
  },
  editorClick: function (e) {
    ...
    console.log(e)
    wx.navigateTo({
      url: '/pages/sociology/sociology?main=' + JSON.stringify(this.data.main) + '&index=' + _index,
    })
  },
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          ...
          //获取要删除的id
          util._post(config.service.upload, { field: 'majorSocialRelationsMembership', info: _main }, function (res) {
            wx.showToast({
              title: '删除成功',
