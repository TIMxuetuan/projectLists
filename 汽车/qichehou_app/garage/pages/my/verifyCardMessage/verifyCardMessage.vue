	...
	<view>
		<view class="verifcard-message">
			...
			<view class="addbank-card-btn">
				<u-button @click="gotoAuthCode" shape="circle" type="error" :disabled=" model.phone == '' ?  true : false ">同意协议并验证</u-button>
			</view>
		</view>
	</view>
</template>
