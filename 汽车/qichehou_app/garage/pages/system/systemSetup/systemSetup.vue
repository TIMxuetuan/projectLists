<template>
	<view>
		<view class="system-setup">
			...
			<!--支付密码-->
			<view class="four-set-item" @click="gotoPayPassword">
				<view class="">
					支付密码
				</view>
				<view class="">
			...
			<!--版本更新-->
			<view class="four-set-item" @click="gotoVersionUpdating">
				<view class="">
					版本更新
				</view>
				<view class="four-set-right">
		...
		<view class="balance-content-btn">
			<u-button :custom-style="balanceBtn" shape="circle" type="error" @click="withdrawClick">退出登录</u-button>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			gotoChangePassword() {
				uni.navigateTo({
					url: '/pages/system/changePassword/changePassword'
				});
			},
			...
			gotoBindingNewPhone() {
				uni.navigateTo({
					url: '/pages/system/bindingNewPhone/bindingNewPhone'
				});
			},
			...
			gotoPayPassword(){
				uni.navigateTo({
					url: '/pages/system/changePayPassword/changePayPassword'
				});
			},
			...
			gotoVersionUpdating(){
				uni.navigateTo({
					url: '/pages/system/versionUpdating/versionUpdating'
				});
			}
