<template>
	<view style="font-size: 16px;" class="cmd-cell-item" :class="{'is-disabled': disabled,'no-border': !border }" @tap="$_click" :hover-class="hoverClass">
		...
		<view v-if="addon2" v-text="addon2" class="cmd-cell-item-children" style="font-size: 16px;color: #858b9c;"></view>
	</view>
</template>
